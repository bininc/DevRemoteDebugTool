...
namespace WpfAutoUpdate
{
    public class CRC
    {
        ...
        */
        static readonly UInt32[] crc32_table = {  
  ...
  0xbcb4666d,  0xb8757bda,  0xb5365d03,  0xb1f740b4
        ...
        ===========================================================================*/
        public static uint crc_32_calc
        (
        ...
        )
        {
            ...
            {
                crc = crc32_table[((crc >> 24) ^ (buffer[buf_ptr]))] ^ (crc << 8);
            }
